...
const TCHAR ProductNames::PRODUCT_NAME[] = _T("SwapLocal");
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("SwapLocal Server");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\SwapLocal\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\SwapLocal\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\SwapLocal\\Control\\DispatcherConnectionHistory");

const TCHAR WindowNames::WINDOW_CLASS_NAME[] =
  _T("TvnWindowsApplicationClass");

const TCHAR LogNames::SERVER_LOG_FILE_STUB_NAME[] = _T("swaplocalserver");
const TCHAR LogNames::VIEWER_LOG_FILE_STUB_NAME[] = _T("swaplocalviewer");
const TCHAR LogNames::LOG_DIR_NAME[] = _T("SwapLocal");
const TCHAR LogNames::LOG_PIPE_PUBLIC_NAME[] = _T("TVN_log_pipe_public_name");
const TCHAR LogNames::WIN_EVENT_PROVIDER_NAME[] = _T("swaplocalserver");

const TCHAR ClipboardNames::CLIPBOARD_WIN_CLASS_NAME[] = 
  _T("swaplocalserver.Clipboard.MessageWindow");


const TCHAR ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME[] =
  _T("tvncontrol");
const TCHAR ServiceNames::SERVICE_NAME[] = _T("swaplocal");
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("SwapLocal Server");

const TCHAR ServerApplicationNames::SERVER_INSTANCE_MUTEX_NAME[] =
  _T("swaplocalserverApplication");
const TCHAR ServerApplicationNames::CONTROL_APP_INSTANCE_MUTEX_NAME[] =
  _T("swaplocalserverServiceControlSlave");
const TCHAR ServerApplicationNames::FOR_SERVICE_CONTROL_APP_PIPE_NAME[] =
  _T("SwapLocal_Service_Control");
const TCHAR ServerApplicationNames::FOR_APP_CONTROL_APP_SERVICE_PIPE_NAME[] =
  _T("SwapLocal_Application_Control");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("SwapLocal Server");


const char HttpStrings::HTTP_INDEX_PAGE_FORMAT[] =
"<HTML>\n"
"  <HEAD><TITLE>SwapLocal desktop [%.256s]</TITLE></HEAD>\n"
"  <BODY>\n"
...
"%.1024s"
"    </APPLET><BR>\n"
"    <A HREF=\"http://onescreensolutions.com/\">www.TightVNC.com</A>\n"
"  </BODY>\n"
"</HTML>\n";

const char HttpStrings::HTTP_MSG_BADPARAMS[] =
"<HTML>\n"
"  <HEAD><TITLE>SwapLocal desktop</TITLE></HEAD>\n"
"  <BODY>\n"
